    ...
    public class CustomerRepository : BaseRepository, IRepository<Customer>
    {
        ...
        public void Delete(string entityCode)
        {
            using (var connection = GetConnection())
            {
                ...
                var command = new SqlCommand("DELETE [CustomerLib_Demin].[dbo].[Customer] WHERE CustomerId = @CustomerId", connection);
        ...
        public List<Customer> GetAll(string customerId)
        {
            ...
            using (var connection = GetConnection())
            {
                ...
                var command = new SqlCommand("SELECT * FROM [CustomerLib_Demin].[dbo].[Customer]", connection);               
